...
import OrderCreateForm from "../components/orders-page/order-create-form";
                        ...
                        <Grid item>
                            <Paper sx={{p: 3}}>
                                <Card>
                                    ...
                                    <CardActions>
                                        {userType === "C" ? <OrderCreateForm/> : null}
                                    </CardActions>
                                </Card>
                        ...
                        <Grid item>
                            <Paper sx={{p: 3}}>
                                <Card>
                                    ...
                                    <CardActions>
                                        {userType === "C" ? <Button size="small" disabled>We are working on it</Button>: null}
                                    </CardActions>
                                </Card>
                                <Typography variant="h5" mt={3} textAlign={"center"}>
                                    150$

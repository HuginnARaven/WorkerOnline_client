...
import AutoAppointmentPage from "./auto-appointment-page";
...
export default function Header() {
    ...
    const [renderPart, setPart] = useState('Appointments');
    ...
    return (
        <Box sx={{ display: 'flex' }}>
            ...
            <AppBar position="fixed" open={open}>
                <Toolbar>
                    {isLogin ? (<IconButton color="inherit" aria-label="open drawer" onClick={handleDrawerOpen} edge="start" sx={{marginRight: 5, ...(open && { display: 'none' }),}}>
                        <MenuIcon/>
                    </IconButton>) : null}
            ...
            (<Drawer variant="permanent" open={open}>
                ...
                <Divider />
                <List>
                    {['Workers', 'Tasks', 'Appointments', 'Dev'].map((text, index) => (
